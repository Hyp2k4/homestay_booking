...
export default function PageNotFound() {
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-b from-gray-100 to-gray-300">
      <style jsx>{`
        @keyframes float {
      ...
      `}</style>
      <motion.div
        className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700"
      ...
      >
        ...
        >
          ...
          <motion.button
            className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg shadow focus:outline-none focus:shadow-outline-blue hover:bg-blue-700 transition-colors duration-150"
        ...
        >
          ...
          >
            ...
            <path
              className="cls-17"
              d="M465,262.82l-14.13-42.59A53.66,53.66,0,0,0,379,200l-10.53,2.21A31.57,31.57,0,0,0,348.89,251l27,38.3,84.61,30.61Z"
            />
