...
const ListRoom = () => {
  const [rooms, setRooms] = useState(roomsDummyData); // Placeholder for room data
  return (
    <div>
          ...
          <tbody className='text-sm'>
            {
              rooms.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className='py-3 px-4 text-gray-700 border-t border-gray-300'>
                    {formatCurrency(item.pricePerNight)} VND
                  </td>
                  <td
                    ...
                    <label
                      ...
                      <span
                        className='dot absolute left-1 top-1 w-5 h-5 bg-white rounded-full transition-transform duration-200 ease-in-oute peer-checed:translate-x-5'></span>
                    </label>
                  </td>
                </tr>
              ))
