...
const AddRoom = () => {
  ...
  const onSubmitHandle = async (e) => {
    ...
    if (!inputs.roomType || !inputs.pricePerNight || !inputs.description.trim() || !Object.values(images).some(image => image)) {
  ...
  return (
    <form onSubmit={onSubmitHandle}>
      ...
      <textarea
        ...
        className='border border-gray-300 mt-1 rounded p-2 w-full min-h-[100px]'
